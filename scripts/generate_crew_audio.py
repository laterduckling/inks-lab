...
INK_MISC_LINES = {
    ...
    'practice-fr': "Allez ! On va faire un peu d'entraînement supplémentaire pour gagner des pièces bonus, et essayer de débloquer le légendaire poulpe Dragon de Feu ! Prends une photo bien nette de ta feuille d'entraînement — tiens l'iPad bien droit, et vérifie que la page est bien éclairée.",
}
